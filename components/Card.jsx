...
export default function Card({ article, category, vertical, key }) {
      ...
      {vertical ? (
        <article className="mx-auto bg-white overflow-hidden md:max-w-xl">
          ...
          <div className="p-4">
            ...
            <p className="mt-2 text-gray-500 text-xs uppercase">
              {" "}
          ...
          <div class="pt-5 self-center sm:pt-0 sm:pl-8 col-span-3">
            ...
            <h1>
              <a
                ...
                className="font-serif capitalize block mt-1 text-lg leading-tight font-medium hover:underline pb-4"
              >
                {article && article.title}
              </a>
            </h1>
